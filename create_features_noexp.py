...
def main():
    ...
    train_features = interpreter.batch_interpret_noexp(train_inputs)
    dev_features = interpreter.batch_interpret_noexp(dev_inputs)
    test_features = interpreter.batch_interpret_noexp(test_inputs)
